...
@Component({
  selector: 'app-add-author-details',
  templateUrl: './add-author-details.component.html',
  styleUrls: ['./add-author-details.component.css']
})
export class AddAuthorDetailsComponent implements OnInit {
